...
public class FuelController {
    ...
    public List<FuelConsumption> add(@RequestBody  List<FuelConsumption> fuelConsumption) throws FuelTypeNotFound {
    ...
    public List<FuelConsumption> updateDetails(@RequestBody List<FuelConsumption> fuelConsumption){
        return fuelService.updateDetails(fuelConsumption);
    }
    @RequestMapping(value = "/delete/{id}",method = RequestMethod.DELETE)
    public boolean updateDetails(@PathVariable Integer id){
